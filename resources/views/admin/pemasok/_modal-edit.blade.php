<div class="modal fade" id="edit-pemasok" tabindex="-1" aria-labelledby="editpemasoklabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form action="{{ route('editpemasok') }}"  method="post" id="form-edit-pemasok">
            @csrf
            <div class="modal-header">
               <h5 class="modal-title" id="editpemasoklabel">Edit Pemasok</h5>
